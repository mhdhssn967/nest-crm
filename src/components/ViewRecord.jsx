...
{/* Record table System */}
    <table className="record-table pc-view" style={{ width: "100%", borderSpacing: "0 10px" }}>
      <tbody>
        <tr>
          <td><strong><i className="fa-solid fa-hospital"></i> Institute Name:</strong></td>
          <td>
            {isEditing ? (
              <input type="text" value={editedData.clientName} onChange={(e) => handleChange(e, "institutionName")} />
            ) : (
              editedData.clientName
            )}
          </td>
          <td><strong><i className="fa-solid fa-calendar"></i> Initial Date:</strong></td>
          <td>{editedData.date}</td>
        </tr>

        <tr>
          <td><strong><i className="fa-solid fa-user-tie"></i> Associate:</strong></td>
          <td>{editedData.employeeName}</td>
          <td><strong><i className="fa-solid fa-bookmark"></i> Status:</strong></td>
          <td>
            {isEditing ? (
              <select value={editedData.currentStatus} onChange={(e) => handleChange(e, "currentStatus")}>
        ...
        <tr>
          <td><strong><i className="fa-solid fa-location-dot"></i> Place:</strong></td>
          <td>
            {isEditing ? (
          ...
          <td><strong><i className="fa-solid fa-globe"></i> Country:</strong></td>
          <td>
            {isEditing ? (
        ...
        <tr>
          <td><strong><i className="fa-solid fa-id-badge"></i> Person of Contact:</strong></td>
          <td>
            {isEditing ? (
          ...
          <td><strong><i className="fa-solid fa-square-phone"></i> Contact No:</strong></td>
          <td>
            {isEditing ? (
              <input type="number" value={editedData.contactNo} onChange={(e) => handleChange(e, "contactNo")} />
            ) : (
              <a onClick={() => copyToClipboard(editedData.contactNo)} href={`tel:${editedData.contactNo}`}>{editedData.contactNo}</a>
            )}
          </td>
        </tr>
        ...
        {editedData.personOfContact2 && (
          <tr>
            <td><strong> <i className="fa-solid fa-id-badge"></i>Person of Contact 2:</strong></td>
            <td>
              {isEditing ? (
            ...
            <td><strong>Contact No 2:</strong></td>
            <td>
              {isEditing ? (
                <input type="text" value={editedData.contactNo2} onChange={(e) => handleChange(e, "contactNo2")} />
              ) : (
        ...
        <tr>
          <td><strong><i className="fa-solid fa-people-arrows"></i> Referral Person:</strong></td>
          <td>
            {isEditing ? (
          ...
          <td><strong><i className="fa-solid fa-at"></i> Email ID:</strong></td>
          <td>
            {isEditing ? (
              <input type="email" value={editedData.email} onChange={(e) => handleChange(e, "email")} />
            ) : (
              <a href={`mailto:${editedData.email}`}>{editedData.email}</a>
            )}
          </td>
        </tr>

        <tr>
          <td><strong><i className="fa-solid fa-money-bill"></i> Initial Quotes Price:</strong></td>
          <td>
            {isEditing ? (
          ...
          <td><strong><i className="fa-solid fa-money-bill"></i> Final Agreed Price:</strong></td>
          <td>
            {isEditing ? (
        ...
        <tr>
          <td><strong><i className="fa-solid fa-calendar-days"></i> Last Contacted Date:</strong></td>
          <td>
            {isEditing ? (
          ...
          <td><strong><i className="fa-solid fa-clock"></i> Next Follow Up Date:</strong></td>
          <td>
            {isEditing ? (
        ...
        <tr>
          <td><strong><i className="fa-solid fa-pen-to-square"></i> Remarks:</strong></td>
          <td colSpan="3">
            {isEditing ? (
              <textarea style={{ width: "100%" }} value={editedData.remarks} onChange={(e) => handleChange(e, "remarks")} />
            ) : (
              editedData.remarks
            )}
          </td>
...
{/* Record table Mobile */}
    <table className="record-table mobile-view" style={{ width: "100%", borderSpacing: "0 10px" }}>
      <tbody>
        <tr>
          <td><strong><i className="fa-solid fa-hospital"></i> Institute Name:</strong></td>
          <td>
    ...
    <div className="btn-div" style={{ display: "flex", justifyContent: "flex-end", gap: "10px", marginTop: "20px" }}>
      {isEditing ? (
